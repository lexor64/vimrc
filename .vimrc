...
set t_Co=256
colorscheme molokai
"Строка ниже для выделения столбца на 80 и 100 символов. Это хороший ориентир для длины строки для файлов, которые не будут автоматически форматироваться.
